...
b=int(input('Введите шаг сдвига от 0 до 25: '))                                                      #Ввод шага сдвига
 if (b>=0) and (b<=25):                                                                               #Условие для шага сдвига, чтобы программа выполнялась успешно
        ...
        shifr=''
        if shifrovka==1:
          for i in input('Введите сообщение на английском языке, которое необходимо зашифровать: ').upper():           #Диалоговый режим с пользователем при условии, что мы
          ...
          for i in input('Введите сообщение на английском языке, которое необходимо расшифровать: ').upper():                     #Диалоговый режим с пользователем при условии, что мы 
